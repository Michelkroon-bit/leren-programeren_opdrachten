...
# Test de werking van de functions voor verschillende soorten tekst. LET OP: print() hoort niet thuis in deze function.

uitkomst_get_subsentences = get_subsentences('''Geachte heer/mevrouw,
...
print(get_ego_score(uitkomst_get_subsentences))
